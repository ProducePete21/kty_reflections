...
const ReflectionsCalculator = () => {
   ...
   const calculateReflections = (personalKtyAddress) => {
       ...
       let totalSupply = 69419373700000;
       ...
       allTrx.forEach(trxArray => {
           trxArray.forEach(trx => {
               ...
               // Checks for trx that is reflections eligible and runs reflections math
                    ...
                    //    console.log('***********')
                    //    console.log(`trx value: ${trx.value * decimalConst}`);
                    //    console.log(`Starting KTY Balance: ${personalKtyAmount}`)
                    ...
                    //    console.log(`trx Reflection: ${elementReflection}`);
 
                       personalKtyAmount = personalKtyAmount + elementReflection;
                    //    console.log(`KTY Balance: ${personalKtyAmount}`);
                    ...
                    //    console.log(`trx Date: ${elementDate.getUTCMonth()} ${elementDate.getUTCDate()}, ${elementDate.getUTCFullYear()}`);
                    //    console.log('************')
